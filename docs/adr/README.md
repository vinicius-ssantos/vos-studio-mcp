...
| [0009](0009-use-provider-adapters-for-higgsfield-freepik-and-magnific.md) | Use provider adapters for Higgsfield, Freepik, and Magnific | Accepted |
| [0010](0010-treat-the-creative-sprint-as-the-core-domain-entity.md) | Treat the Creative Sprint as the core domain entity | Accepted |
...
| [0016](0016-use-environment-variables-and-secret-management-for-credentials.md) | Use environment variables and secret management for credentials | Accepted |
