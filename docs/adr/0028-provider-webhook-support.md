...
| `POST /webhooks/higgsfield` FastAPI endpoint | ✅ Implemented (PR #9) |
| Celery `poll_video_job` task | ✅ Implemented (PR #9) |
| Celery `upload_video_to_storage` task | ✅ Implemented (PR #9) |
| `get_video_job_status` MCP tool | ✅ Implemented (PR #9) |
